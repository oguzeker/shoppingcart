 ...
 *
 */
public class XMLGregorianCalendarConverterForDate implements CustomConverter {
	...
	public Object convert(Object destination, Object source, Class destClass, Class sourceClass) {
		...
		if (source instanceof XMLGregorianCalendar) {
			...
			return DateUtil.toXMLGregorianCalendar((Date) source, DateUtil.DEFAULT_DATE_FORMAT);
		} else {
